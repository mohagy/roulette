<?php
/**
 * Roulette Analytics Admin Page
 * 
 * This page allows administrators to view and manage roulette analytics data
...
<head>
    ...
    <title>Roulette Analytics Admin</title>
...
<body>
    <div class="container">
        <h1 class="mb-4">Roulette Analytics Admin</h1>
